    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <p className="text-gray-400 text-base leading-relaxed mb-16 max-w-xl">
          Bozeman is one of the fastest-growing luxury real estate markets in the American West. Premium homes in the Gallatin Valley deserve a garage floor that matches.
        </p>
        ...
        <div className="space-y-12 text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>At 4,800 feet elevation, Bozeman sees real winter. Temperatures drop below zero, road salt gets tracked in from November through April, and the freeze-thaw cycle is brutal on untreated concrete. Standard big-box epoxy kits simply weren't designed for this.</p>
            <p className="mt-4">Our polyaspartic system is 100% UV-stable, flexible enough to handle Montana's temperature swings, and chemically resistant to road salt and vehicle fluids that are unavoidable in a Bozeman garage.</p>
          </section>
          ...
          <section>
            ...
            <p>Most Bozeman residential garages fall between 400–800 square feet. At our rate of $7–$12 per square foot installed:</p>
            ...
            <p className="mt-4 text-gray-500 text-xs">Includes surface preparation, crack repair, base coat, flake broadcast, and polyaspartic topcoat. Pricing may vary based on concrete condition.</p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                { title: "Freeze-Thaw Performance", desc: "Our flexible polyurea base coat handles Bozeman's temperature swings without cracking or delaminating." },
                ...
                { title: "Lifetime Warranty", desc: "Every Summit installation is backed by a lifetime warranty. We stand behind the system." },
              ].map((item) => (
                <div key={item.title} className="flex gap-4 p-4 border border-white/[0.07] rounded-sm">
                  <div className="w-1 h-full bg-[#C8A96E] rounded-full flex-shrink-0 self-stretch" />
                  <div>
        ...
        <div className="mt-16 p-8 border border-[#C8A96E]/20 rounded-sm bg-[#C8A96E]/[0.03]">
          ...
          <p className="text-gray-500 text-sm mb-6">We visit your property, assess your concrete, and give you an honest quote. No pressure, no obligation.</p>
          <div className="flex flex-col sm:flex-row gap-3">
            <a href="tel:+17867085686"
              className="text-[11px] tracking-[0.16em] uppercase bg-[#C8A96E] text-black px-8 py-4 rounded-sm hover:bg-[#8B6E3E] hover:text-white transition-all text-center">
              Call (786) 708-5686
            </a>
            <a href="mailto:hello@summitgaragefloors.com"
              className="text-[11px] tracking-[0.16em] uppercase border border-white/20 text-white px-8 py-4 rounded-sm hover:border-[#C8A96E] transition-all text-center">
              Email Us
            </a>
          </div>
        </div>
