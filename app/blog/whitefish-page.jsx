...
export const metadata = {
  ...
  description: "Premium polyaspartic garage floor coatings for Whitefish and Flathead Valley luxury homes.",
};
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <p className="text-gray-400 text-base leading-relaxed mb-16 max-w-xl">Whitefish is home to some of Montana's most spectacular luxury properties — ski-in/ski-out residences, lakefront estates, and custom timber-frame homes throughout the Flathead Valley.</p>
        <div className="space-y-12 text-gray-300 text-sm leading-relaxed">
          <section>
            ...
            <p>Western Montana gets significant UV exposure. Standard epoxy coatings yellow badly within a year. Our polyaspartic topcoat is 100% UV-stable and will not yellow, fade, or discolor.</p>
          </section>
          <section>
            <h2 className="font-serif text-2xl text-white font-light mb-4">Popular Finishes</h2>
            <div className="space-y-4">
              <div className="border border-white/[0.07] rounded-sm p-4"><div className="font-serif text-white text-lg mb-1">Arctic White</div><p className="text-gray-500 text-xs">Bright showroom-white finish. Stunning with dark cars and timber-frame aesthetics.</p></div>
              <div className="border border-white/[0.07] rounded-sm p-4"><div className="font-serif text-white text-lg mb-1">Titanium Blend</div><p className="text-gray-500 text-xs">Gray and silver flake. The most versatile choice for any home style.</p></div>
              <div className="border border-white/[0.07] rounded-sm p-4"><div className="font-serif text-white text-lg mb-1">Midnight Stone</div><p className="text-gray-500 text-xs">Black and charcoal flake. Bold and dramatic for serious car collectors.</p></div>
            </div>
          </section>
          <section>
            <h2 className="font-serif text-2xl text-white font-light mb-4">Service Area</h2>
          ...
          <section>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center py-3 border-b border-white/[0.07]"><span className="text-gray-400">1-car garage (~200 sq ft)</span><span className="font-serif text-[#C8A96E] text-lg">$1,400 - $2,400</span></div>
              <div className="flex justify-between items-center py-3 border-b border-white/[0.07]"><span className="text-gray-400">2-car garage (~480 sq ft)</span><span className="font-serif text-[#C8A96E] text-lg">$3,360 - $5,760</span></div>
              <div className="flex justify-between items-center py-3 border-b border-white/[0.07]"><span className="text-gray-400">3-car garage (~720 sq ft)</span><span className="font-serif text-[#C8A96E] text-lg">$5,040 - $8,640</span></div>
            </div>
          </section>
        </div>
        <div className="mt-16 p-8 border border-[#C8A96E]/20 rounded-sm bg-[#C8A96E]/[0.03]">
          ...
          <p className="text-gray-500 text-sm mb-6">We visit your property and give you an honest quote. No pressure.</p>
